...
MID_OBJS += $(BPEJ_EXTRACTED_MID_OBJS)
endif
...
$(MID_BUILDDIR)/%.o: $(BPEJ_EXTRACTED_SOUND_DIR)/$(MID_SUBDIR)/%.s $(BPEJ_SOUND_EXTRACTED_OK)
...
firered leafgreen:
	$(error FRLG builds are not supported in this Emerald-only Japanese project)
