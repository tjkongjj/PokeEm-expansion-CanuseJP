...
static const struct Landmark Landmark_FlowerShop = {COMPOUND_STRING("{JPN}フラワーショップ"), FLAG_LANDMARK_FLOWER_SHOP};
static const struct Landmark Landmark_PetalburgWoods = {COMPOUND_STRING("{JPN}トウカのもり"), -1};
static const struct Landmark Landmark_MrBrineysCottage = {COMPOUND_STRING("{JPN}ハギろうじんのこや"), FLAG_LANDMARK_MR_BRINEY_HOUSE};
static const struct Landmark Landmark_AbandonedShip = {COMPOUND_STRING("{JPN}すてられぶね"), FLAG_LANDMARK_ABANDONED_SHIP};
static const struct Landmark Landmark_SeashoreHouse = {COMPOUND_STRING("{JPN}うみの いえ"), FLAG_LANDMARK_SEASHORE_HOUSE};
static const struct Landmark Landmark_SlateportBeach = {COMPOUND_STRING("{JPN}カイナのすなはま"), -1};
static const struct Landmark Landmark_CyclingRoad = {COMPOUND_STRING("{JPN}サイクリングロード"), -1};
static const struct Landmark Landmark_NewMauville = {COMPOUND_STRING("{JPN}ニューキンセツ"), FLAG_LANDMARK_NEW_MAUVILLE};
static const struct Landmark Landmark_TrickHouse = {COMPOUND_STRING("{JPN}カラクリやしき"), FLAG_LANDMARK_TRICK_HOUSE};
static const struct Landmark Landmark_OldLadysRestShop = {COMPOUND_STRING("{JPN}おばあさんのいえ"), FLAG_LANDMARK_OLD_LADY_REST_SHOP};
static const struct Landmark Landmark_Desert = {COMPOUND_STRING("{JPN}さばく"), -1};
static const struct Landmark Landmark_WinstrateFamily = {COMPOUND_STRING("{JPN}カチヌキファミリー"), FLAG_LANDMARK_WINSTRATE_FAMILY};
static const struct Landmark Landmark_CableCar = {COMPOUND_STRING("{JPN}ロープウェイのりば"), -1};
static const struct Landmark Landmark_GlassWorkshop = {COMPOUND_STRING("{JPN}ガラスざいくのおみせ"), FLAG_LANDMARK_GLASS_WORKSHOP};
static const struct Landmark Landmark_WeatherInstitute = {COMPOUND_STRING("{JPN}てんきけんきゅうじょ"), -1};
static const struct Landmark Landmark_MeteorFalls = {COMPOUND_STRING("{JPN}りゅうせいのたき"), -1};
static const struct Landmark Landmark_TunnelersRestHouse = {COMPOUND_STRING("{JPN}さぎょういんつめしょ"), FLAG_LANDMARK_TUNNELERS_REST_HOUSE};
static const struct Landmark Landmark_RusturfTunnel = {COMPOUND_STRING("{JPN}カナシダトンネル"), -1};
static const struct Landmark Landmark_PokemonDayCare = {COMPOUND_STRING("{JPN}ポケモンそだてや"), FLAG_LANDMARK_POKEMON_DAYCARE};
static const struct Landmark Landmark_SafariZoneEntrance = {COMPOUND_STRING("{JPN}サファリゾーンいりぐち"), -1};
static const struct Landmark Landmark_MtPyre = {COMPOUND_STRING("{JPN}おくりびやま"), -1};
static const struct Landmark Landmark_ShoalCave = {COMPOUND_STRING("{JPN}あさせのほらあな"), -1};
static const struct Landmark Landmark_SeafloorCavern = {COMPOUND_STRING("{JPN}かいていどうくつ"), FLAG_LANDMARK_SEAFLOOR_CAVERN};
static const struct Landmark Landmark_GraniteCave = {COMPOUND_STRING("{JPN}いしのどうくつ"), -1};
static const struct Landmark Landmark_OceanCurrent = {COMPOUND_STRING("{JPN}かいりゅう"), -1};
static const struct Landmark Landmark_LanettesHouse = {COMPOUND_STRING("{JPN}マユミのいえ"), FLAG_LANDMARK_LANETTES_HOUSE};
static const struct Landmark Landmark_FieryPath = {COMPOUND_STRING("{JPN}ほのおのぬけみち"), FLAG_LANDMARK_FIERY_PATH};
static const struct Landmark Landmark_JaggedPass = {COMPOUND_STRING("{JPN}デコボコさんどう"), -1};
static const struct Landmark Landmark_BerryMastersHouse = {COMPOUND_STRING("{JPN}きのみめいじんのいえ"), FLAG_LANDMARK_BERRY_MASTERS_HOUSE};
static const struct Landmark Landmark_IslandCave = {COMPOUND_STRING("{JPN}こじまのよこあな"), FLAG_LANDMARK_ISLAND_CAVE};
static const struct Landmark Landmark_DesertRuins = {COMPOUND_STRING("{JPN}さばくいせき"), FLAG_LANDMARK_DESERT_RUINS};
static const struct Landmark Landmark_ScorchedSlab = {COMPOUND_STRING("{JPN}ひでりのいわと"), FLAG_LANDMARK_SCORCHED_SLAB};
static const struct Landmark Landmark_AncientTomb = {COMPOUND_STRING("{JPN}こだいづか"), FLAG_LANDMARK_ANCIENT_TOMB};
static const struct Landmark Landmark_SealedChamber = {COMPOUND_STRING("{JPN}おふれのいせき"), FLAG_LANDMARK_SEALED_CHAMBER};
static const struct Landmark Landmark_FossilManiacsHouse = {COMPOUND_STRING("{JPN}かせきマニアのいえ"), FLAG_LANDMARK_FOSSIL_MANIACS_HOUSE};
static const struct Landmark Landmark_HuntersHouse = {COMPOUND_STRING("{JPN}トレジャーハンターのいえ"), FLAG_LANDMARK_HUNTERS_HOUSE};
static const struct Landmark Landmark_SkyPillar = {COMPOUND_STRING("{JPN}そらのはしら"), FLAG_LANDMARK_SKY_PILLAR};
static const struct Landmark Landmark_MirageTower = {COMPOUND_STRING("{JPN}げんえいのとう"), FLAG_LANDMARK_MIRAGE_TOWER};
static const struct Landmark Landmark_AlteringCave = {COMPOUND_STRING("{JPN}へんげのどうくつ"), FLAG_LANDMARK_ALTERING_CAVE};
static const struct Landmark Landmark_DesertUnderpass = {COMPOUND_STRING("{JPN}さばくのちかどう"), FLAG_LANDMARK_DESERT_UNDERPASS};
static const struct Landmark Landmark_TrainerHill = {COMPOUND_STRING("{JPN}トレーナーヒル"), FLAG_LANDMARK_TRAINER_HILL};
