...
static const struct Landmark Landmark_SeashoreHouse = {COMPOUND_STRING("{JPN}うみのいえ"), FLAG_LANDMARK_SEASHORE_HOUSE};
static const struct Landmark Landmark_SlateportBeach = {COMPOUND_STRING("{JPN}カイナのすなはま"), -1};
static const struct Landmark Landmark_CyclingRoad = {COMPOUND_STRING("{JPN}サイクリング ロード"), -1};
...
static const struct Landmark Landmark_OldLadysRestShop = {COMPOUND_STRING("{JPN}ケンコーばあさん"), FLAG_LANDMARK_OLD_LADY_REST_SHOP};
static const struct Landmark Landmark_Desert = {COMPOUND_STRING("{JPN}さばく"), -1};
static const struct Landmark Landmark_WinstrateFamily = {COMPOUND_STRING("{JPN}カチヌキ ファミリー"), FLAG_LANDMARK_WINSTRATE_FAMILY};
static const struct Landmark Landmark_CableCar = {COMPOUND_STRING("{JPN}ロープウェイのりば"), -1};
static const struct Landmark Landmark_GlassWorkshop = {COMPOUND_STRING("{JPN}ガラスざいくのみせ"), FLAG_LANDMARK_GLASS_WORKSHOP};
...
static const struct Landmark Landmark_BerryMastersHouse = {COMPOUND_STRING("{JPN}きのみ めいじんのいえ"), FLAG_LANDMARK_BERRY_MASTERS_HOUSE};
...
static const struct Landmark Landmark_SealedChamber = {COMPOUND_STRING("{JPN}おふれのせきしつ"), FLAG_LANDMARK_SEALED_CHAMBER};
...
static const struct Landmark Landmark_HuntersHouse = {COMPOUND_STRING("{JPN}ハンターのこや"), FLAG_LANDMARK_HUNTERS_HOUSE};
