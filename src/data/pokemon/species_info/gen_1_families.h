...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_GROWLITHE_HISUI] =
    {
        ...
        .weight = 227,
        .description = COMPOUND_STRING(
            "{JPN}ついになりて なわばりを しょうかいす。\nたいもうに かせいがんなる せいぶん まざるは\nかざんかつどうの えいきょうと すいさつす。"),
        .pokemonScale = 346,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARCANINE_HISUI] =
    {
        ...
        .weight = 1680,
        .description = COMPOUND_STRING(
            "{JPN}もえさかるほのお きばにまとわせ くらいつく。\nたいく おおがらなれど ようどう あざやかなりて\nてき ほんろうせしむるすがた えんぶのごとし。"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 312,
        .trainerOffset = 4,
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_MUK] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "{JPN}あたたかく しっけの おおい とちを このむ。\nなつばは たいないの どくそが さらに つよまり\nなまごみが くさったような においを だす。"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_VOLTORB_HISUI] =
    {
        ...
        .weight = 130,
        .description = COMPOUND_STRING(
            "{JPN}モンスターボールと そらにせし なぞの\nポケモン。き たかぶるほど はらに\nたくわえしでんりゅうを ときはなち たいしょうす。"),
        .pokemonScale = 364,
        .pokemonOffset = -8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ELECTRODE_HISUI] =
    {
        ...
        .weight = 710,
        .description = COMPOUND_STRING(
            "{JPN}たいひょうのそしき ぼんぐりのせいぶんと きわめて\nちかく ふしぎ。いらだちしときに はなつ\nでんりゅうは らくらい 20かいぶんに ひってきす。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
