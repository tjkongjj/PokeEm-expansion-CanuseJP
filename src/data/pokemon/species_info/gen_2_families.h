...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}はっぱから あまい かおりが ただようので おたがいに\n"
            "{JPN}なごやかな ふんいきに なるよ。 おとなしくて\n"
            "{JPN}ひざしを あびるのが だいすき。"),
        .pokemonScale = 512,
        .pokemonOffset = 20,
        .trainerScale = 256,
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .weight = 158,
        .description = COMPOUND_STRING(
            "{JPN}くびの まわりの くるりと まいた はっぱの なかには\n"
            "{JPN}ちいさな きのめが 1こ なっている。その かおりは\n"
            "{JPN}ひとを げんきに させるぞ。\n"
            "{JPN}なぜだか たたかいたくなる ことも ある。"),
        .pokemonScale = 296,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .weight = 1005,
        .description = COMPOUND_STRING(
            "{JPN}はなの かおりは きもちを おだやかにする。 たたかいの\n"
            "{JPN}ときは かおりを はっさんさせて あいての たたかう\n"
            "{JPN}きもちを にぶらせるのだ。 そばに いると しんりんよくを\n"
            "{JPN}したような すがすがしい きぶんに なれる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 277,
        .trainerOffset = 1,
    ...
    [SPECIES_MEGANIUM_MEGA] =
    {
        ...
        .weight = 2010,
        .description = COMPOUND_STRING(
            "{JPN}メガシンカし からだが すこし おおきくなった。\n"
            "{JPN}くびの はなは 4りんに ふえた。\n"
            "{JPN}4りんの はなから はなたれる ソーラービームは\n"
            "{JPN}いりょくぜつだい。 べつめい メガソーラーほう。"),
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}おこった ときの ほのおは いきおいが いいが\n"
            "{JPN}つかれている ときは ふかんぜんねんしょうする。\n"
            "{JPN}おくびょうで いつも からだを まるめている。"),
        .pokemonScale = 539,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .weight = 190,
        .description = COMPOUND_STRING(
            "{JPN}ほのおの いきおいと ねっぷうで いかくする。 すばやい\n"
            "{JPN}みのこなしで あいての こうげきを かわしながら\n"
            "{JPN}どうじに ほのおで もやす。 たたかう たいせいになると\n"
            "{JPN}ほのおの いきおいが ます。"),
        .pokemonScale = 329,
        .pokemonOffset = 11,
        .trainerScale = 256,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}つくりだして すがたを かくす ことが できる。\n"
            "{JPN}もえあがる ばくふうは すべてを やきつくすぞ。\n"
            "{JPN}おおわざを かくしもっている。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
    ...
    [SPECIES_TYPHLOSION_HISUI] =
    {
        ...
        .weight = 698,
        .description = COMPOUND_STRING(
            "{JPN}れいざんの きが えいきょうした すがたと かんがえられる。\n"
            "{JPN}いきばを うしなった たましいを ほのおで じょうかし\n"
            "{JPN}あのよに おくると いわれている。 みのこなしが\n"
            "{JPN}うつくしく じょうひんで おんこうな せいかく。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = 1,
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}ワニノコじしんは あまがみ している つもりでも\n"
            "{JPN}おおけがを してしまう ほどの ちからが ある。\n"
            "{JPN}トレーナーも ちゅういが ひつよう。"),
        .pokemonScale = 487,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROCONAW] =
    {
        ...
        .weight = 250,
        .description = COMPOUND_STRING(
            "{JPN}いちど かみついたら ぜったいに はなさない。 キバの\n"
            "{JPN}さきが つりばり みたいに そりかえって いるので いちど\n"
            "{JPN}ささると ぬけなく なるのだ。 キバは ぬけても つぎから\n"
            "{JPN}つぎに はえてくる。"),
        .pokemonScale = 378,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}きょうじんな うしろあしで じめんを けって ものすごい\n"
            "{JPN}スピードで とっしん してくるぞ。 かみつくと そのまま\n"
            "{JPN}くびをふって あいてを ずたずたに ひきちぎる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    [SPECIES_FERALIGATR_MEGA] =
    {
        ...
        .weight = 1088,
        .description = COMPOUND_STRING(
            "{JPN}せびれの いちぶが おおきくなり うでに あかい ヒレが\n"
            "{JPN}はえた。 きょだいな ワニノコの あたまの ように なる。\n"
            "{JPN}フードのような ヒレと りょううでで きょだいな あごを\n"
            "{JPN}つくり かみつく いりょくは 10ばいに アップした。"),
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .weight = 60,
        .description = COMPOUND_STRING(
            "{JPN}ねむる ときには こうたいで みはりをする。 きけんを\n"
            "{JPN}さっちすると なかまを おこすのだ。むれから はぐれると\n"
            "{JPN}こわくて ねむれなくなる。 とおくまで みわたせるように\n"
            "{JPN}しっぽを つかって せのびをする。"),
        .pokemonScale = 439,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FURRET] =
    {
        ...
        .weight = 325,
        .description = COMPOUND_STRING(
            "{JPN}てきに おそわれても ほそい すきまに するりと\n"
            "{JPN}もぐりこんで にげる ことが できる。 てあしは\n"
            "{JPN}みじかいが とても すばしっこい。 どこから\n"
            "{JPN}シッポか よくわからない。"),
        .pokemonScale = 346,
        .pokemonOffset = 11,
        .trainerScale = 256,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .weight = 212,
        .description = COMPOUND_STRING(
            "{JPN}からだの なかには ちきゅうの じてんを かんじとる\n"
            "{JPN}きかんを もっているので まいにち おなじ じかんに\n"
            "{JPN}なると なきごえを あげる。 あしを いれかえる\n"
            "{JPN}しゅんかんは はやすぎて だれも みていない。"),
        .pokemonScale = 380,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .weight = 408,
        .description = COMPOUND_STRING(
            "{JPN}わずかな ひかりでも みえる すぐれた めと はおとを\n"
            "{JPN}たてない やわらかい はねの おかげで くらやみでは\n"
            "{JPN}えものを ぜったいに にがさない。 やみよの\n"
            "{JPN}ていおうとも よばれる。"),
        .pokemonScale = 278,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .weight = 108,
        .description = COMPOUND_STRING(
            "{JPN}あしの つけねから だす えきたいの においで なかまと\n"
            "{JPN}コミュニケーションを とっている。 においの ちがいで\n"
            "{JPN}きもちを つたえるという。 むれを つくらないと\n"
            "{JPN}ふあんで うごけなくなるほど おくびょう。"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .weight = 356,
        .description = COMPOUND_STRING(
            "{JPN}ほしが たくさん みえる くうきの きれいな とちには\n"
            "{JPN}レディアンが たくさん すむと いう。 ほしあかりを\n"
            "{JPN}エネルギーに しているからだ。 よぞらの ほしの かずが\n"
            "{JPN}ふえると せなかの もようが おおきくなる。"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
            "{JPN}いとで つくった ワナは だい2の しんけい。 いとを\n"
            "{JPN}つたわる わずかな しんどう だけで えものの しゅるいが\n"
            "{JPN}わかると いわれている。 キバの どくは さほど つよくないが\n"
            "{JPN}うごけない えものを よわらせるには じゅうぶん。"),
        .pokemonScale = 414,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}てんじょうや すいちょくの かべも あるける。 ほそく\n"
            "{JPN}じょうぶな いとで てきを しめあげる。 しりからも\n"
            "{JPN}くちからも いとをだす。"),
        .pokemonScale = 316,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .weight = 120,
        .description = COMPOUND_STRING(
            "{JPN}つよい でんきを はっせいさせる さいぼうが しょくしゅの\n"
            "{JPN}なかに つまっている。 きけんを さっちすると 2ほんの\n"
            "{JPN}しょくしゅから プラスと マイナスの でんきを ながす。\n"
            "{JPN}ひかりの とどかない かいていで くらす。"),
        .pokemonScale = 424,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .weight = 225,
        .description = COMPOUND_STRING(
            "{JPN}しんかいのほしと よばれる ポケモンだ。 よなかに\n"
            "{JPN}ふねから くらい うみを のぞきこむと しんかいを およぐ\n"
            "{JPN}ランターンの ひかりが ほしぞらの ように みえることが\n"
            "{JPN}あるよ。 しんかいの やみを てらす ポケモン。"),
        .pokemonScale = 269,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .weight = 15,
        .description = COMPOUND_STRING(
            "{JPN}ひとや ポケモンが はっしている やさしさや たのしい\n"
            "{JPN}きもちを エネルギーに している。 カラの なかに ためた\n"
            "{JPN}しあわせを わけている。 やさしい ひとに しあわせを\n"
            "{JPN}わけあたえるという。"),
        .pokemonScale = 507,
        .pokemonOffset = 23,
        .trainerScale = 256,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}じゅんすいな こころの もちぬしを みつけると\n"
            "{JPN}すがたを あらわし しあわせを わけあたえる。\n"
            "{JPN}はねをうごかさずに そらにうかべる。"),
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
            "{JPN}もめごとの おこる ばしょには けっして あらわれない。\n"
            "{JPN}おたがいの そんざいを みとめあい むだに あらそわない\n"
            "{JPN}ひとのために さまざまな めぐみを わけあたえる。\n"
            "{JPN}ちかごろは ほとんど みかけない。"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_NATU] =
    {
        ...
        .weight = 20,
        .description = COMPOUND_STRING(
            "{JPN}はねが まだ そだって いないので とべない。 サバンナに\n"
            "{JPN}はえている せたけの ひくい きを かけのぼり あたらしい\n"
            "{JPN}きのめを ついばむ。 なにかを かんさつしている みたいな\n"
            "{JPN}ひとみ。 いつも なにかを みつめている。"),
        .pokemonScale = 610,
        .pokemonOffset = 25,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_XATU] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "{JPN}1にちじゅう たいようを みつめて うごかない。 みらいを\n"
            "{JPN}よちする ふしぎな ちからを もつ。 かみさまが\n"
            "{JPN}つかわせた ポケモンだと むかしから しんじている\n"
            "{JPN}ひとびとが いる。"),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 318,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .weight = 78,
        .description = COMPOUND_STRING(
            "{JPN}たいもうが こすれて せいでんきが たまる。 でんりょくが\n"
            "{JPN}たくさん たまるほど しっぽの さきに ついた\n"
            "{JPN}でんきゅうが あかるく ひかる。 ふわふわの たいもうは\n"
            "{JPN}せいでんきが たまると 2ばいに ふくらむ。"),
        .pokemonScale = 379,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}りょうでも たくさんの でんきを つくりだせる。\n"
            "{JPN}でんきを さえぎる つるつるの はだを もつ。 たいもうに\n"
            "{JPN}ためた でんきが まんたんになると しっぽが ひかる。"),
        .pokemonScale = 372,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}むかしの ひとは デンリュウの あかりを つかい とおくの\n"
            "{JPN}なかまと あいずを おくりあっていた。 くらくなると\n"
            "{JPN}しっぽの さきが まぶしく ひかりかがやく。"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .weight = 615,
        .description = COMPOUND_STRING(
            "{JPN}メガシンカの かじょうな エネルギーが いでんしを しげき。\n"
            "{JPN}ぬけおちたはずの たいもうが ふたたび はえてきた。\n"
            "{JPN}ぼうだいな エネルギーが さいぼうを はげしく しげき。\n"
            "{JPN}ねむっていた ドラゴンの ちが めざめたらしい。"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .weight = 20,
        .description = COMPOUND_STRING(
            "{JPN}えいようが たっぷり つまった しっぽは ゴムボール\n"
            "{JPN}みたいに よく はずむ。 はれた ひは みずべに あつまり\n"
            "{JPN}みずあそび。 だんりょくの ある しっぽに のって\n"
            "{JPN}あそぶ。 みずに うかぶ しっぽは うきわの かわり。"),
        .pokemonScale = 603,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MARILL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}すいちゅうで みずの ていこうを うけずに はやい\n"
            "{JPN}スピードで およぐ ことが できる。 あぶらの\n"
            "{JPN}つまった しっぽは うきわの かわり。"),
        .pokemonScale = 476,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
            "{JPN}ながい みみは マリルリの だいじな センサー。\n"
            "{JPN}1にちの ほとんどを みずの なかで くらす。 からだの\n"
            "{JPN}いろと もようは すいちゅうで てきに みつかり\n"
            "{JPN}にくくする カムフラージュ。"),
        .pokemonScale = 448,
        .pokemonOffset = 16,
        .trainerScale = 256,
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "{JPN}かんそうした くうきの このむ。 たいないの よけいな\n"
            "{JPN}すいぶんを め から だして ちょうせつする。 ないている\n"
            "{JPN}ように みえるだけ。 みどりの たまは かわくほど\n"
            "{JPN}ツヤツヤと にぶく かがやく。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}りょうては 1ねんじゅう みどりいろなので ふゆは\n"
            "{JPN}にせものだと すぐに ばれてしまう。 かぜも ないのに\n"
            "{JPN}ゆれている きを みかけたら それが ウソッキー。"),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}きょうふうの けはいを かんじると なかまどうし はっぱを\n"
            "{JPN}からめ とばされない じゅんびをする。 のやまに ハネッコが\n"
            "{JPN}あつまりだすと はるが おとずれると いわれている。"),
        .pokemonScale = 562,
        .pokemonOffset = -7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "{JPN}きおんが 18どを こえると はなが ひらく。 おんどに\n"
            "{JPN}より はなの ひらきかたが かわるので おんどけいの\n"
            "{JPN}かわりに することも ある。 そらに うかんで ひざしを\n"
            "{JPN}いっぱい あびようとする。"),
        .pokemonScale = 387,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}とおくまで とんでいってしまう ポケモン。 つめたい\n"
            "{JPN}くうきに ふれると じめんに おりる。 とちゅうで\n"
            "{JPN}わたほうしを ばらまく。"),
        .pokemonScale = 418,
        .pokemonOffset = -4,
        .trainerScale = 256,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .weight = 115,
        .description = COMPOUND_STRING(
            "{JPN}きように うごく しっぽの さきを てのひらの かわりに\n"
            "{JPN}つかっていたら はんたいに りょうてが ぶきように\n"
            "{JPN}なってしまった ポケモンだ。 シッポを つかって\n"
            "{JPN}きのえだに ぶらさがる。"),
        .pokemonScale = 363,
        .pokemonOffset = 6,
        .trainerScale = 256,
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .weight = 203,
        .description = COMPOUND_STRING(
            "{JPN}2ほんの しっぽで きのみの からを きように むいて\n"
            "{JPN}たべる。 ぎゃくに うでは ほとんど つかわなくなった。\n"
            "{JPN}おおぜいの むれで こうどうする。 しっぽを つなぎ\n"
            "{JPN}あわせて わっかを つくる。 ゆうじょうの しるしらしい。"),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}とっておくため ほとんど うごこうとしない。 なにも\n"
            "{JPN}たべずに あさつゆ だけを のんでいる。 ある\n"
            "{JPN}あさ とつぜん ふってくる。"),
        .pokemonScale = 541,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}きおんの たかい にっちゅう かっぱつに うごき\n"
            "{JPN}たいようが しずむと ぱったり うごかなくなる。\n"
            "{JPN}たいようを おいかけて いどうする。"),
        .pokemonScale = 444,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}きゅうブレーキや ほうこうてんかんが とくい。\n"
            "{JPN}ねらった えものを すばやく おいつめていく。\n"
            "{JPN}まうしろの えものも みのがさない。"),
        .pokemonScale = 274,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .weight = 515,
        .description = COMPOUND_STRING(
            "{JPN}はばたく ちからが とても つよく ちからづよく とびたつ\n"
            "{JPN}ときは まわりの たいぼくを なぎたおす。 6ほんの あしで\n"
            "{JPN}おとなを かかえて らくらくと とぶ ことが できる。\n"
            "{JPN}しっぽの はねで バランスを とる。"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}さがすときなど たまに ちじょうに でてくる。 りくでは\n"
            "{JPN}どくの ねんえきで からだを おおう。 みずぞこの\n"
            "{JPN}どろに からだを はんぶん うずめて ねむる。"),
        .pokemonScale = 479,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAGSIRE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}とびこんで くるのを ただただ まっている。\n"
            "{JPN}うごかないので あまり おなかが すかないのだ。\n"
            "{JPN}のんびりとした せいかく。"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        .weight = 110,
        .description = COMPOUND_STRING(
            "{JPN}なわばりあらそいに まけて りくで くらすうちに どくの\n"
            "{JPN}ねんまくで からだを ほごするように かわった。\n"
            "{JPN}たんどくこうどうは きけんなので すうひきが いちれつに\n"
            "{JPN}ならんで たすけあいながら ぬまちを あるく。"),
        .pokemonScale = 479,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CLODSIRE] =
    {
        ...
        .weight = 2230,
        .description = COMPOUND_STRING(
            "{JPN}いけや ぬまの みずぞこで くらす。 せなかに ウパーを\n"
            "{JPN}のせて およぎ たいがんまで はこんであげる。 てきに\n"
            "{JPN}おそわれると ふとい トゲを どうたいから つきだして\n"
            "{JPN}はんげき。 みをきる かくごの きけんな わざ。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .weight = 21,
        .description = COMPOUND_STRING(
            "{JPN}ふこうを はこぶと いわれ おそれられていた。 キラキラ\n"
            "{JPN}ひかる ものに きょうみを しめし じょせいの ゆびわを\n"
            "{JPN}とっていこうとする。 ボスのために キラキラ\n"
            "{JPN}ひかるものを さがしている。"),
        .pokemonScale = 401,
        .pokemonOffset = -8,
        .trainerScale = 256,
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .weight = 273,
        .description = COMPOUND_STRING(
            "{JPN}よるになると かつどうを はじめる。 ドンカラスが\n"
            "{JPN}ひくいこえで なくと すぐさま ヤミカラスが あつまるため\n"
            "{JPN}よるをまねくもの とも いわれる。 しっぱいしたり\n"
            "{JPN}うらぎった こぶんは ぜったいに ゆるさない。"),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "{JPN}すすりなく ような なきごえで こわがらせる。 あいての\n"
            "{JPN}こわがる こころを あかい たまで きゅうしゅうして\n"
            "{JPN}えいように している らしい。 ひるまは くらがりで\n"
            "{JPN}ねむっている。"),
        .pokemonScale = 407,
        .pokemonOffset = -8,
        .trainerScale = 256,
    ...
    [SPECIES_MISMAGIUS] =
    {
        ...
        .weight = 44,
        .description = COMPOUND_STRING(
            "{JPN}どこからともなく あらわれる しんしゅつきぼつの\n"
            "{JPN}ポケモン。 じゅもんのような なきごえだが あいてを\n"
            "{JPN}くるしめるもの だけでなく しあわせにする じゅもんも\n"
            "{JPN}ある。 きまぐれに じゅもんを となえる。"),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .weight = 140,
        .description = COMPOUND_STRING(
            "{JPN}いつも ニコニコ えがおの ソーナノ。 あまい くだものが\n"
            "{JPN}だいこうぶつ。 みみの ような うでで きように つみとる。\n"
            "{JPN}かおりに さそわれて かじゅえんに あつまる。 なかま\n"
            "{JPN}たちとの おしくらまんじゅうで がまんづよく そだつ。"),
        .pokemonScale = 484,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WOBBUFFET] =
    {
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
            "{JPN}ふだんは おとなしいが くろい しっぽを こうげきされると\n"
            "{JPN}もうれつに はんげきする。 くろい しっぽを ひっしに\n"
            "{JPN}なって かくすのは しっぽに ひみつがある しょうこだと\n"
            "{JPN}かんぐられている。"),
        .pokemonScale = 274,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .weight = 415,
        .description = COMPOUND_STRING(
            "{JPN}くさや きのめを たべる そうしょくせい。 しっぽの\n"
            "{JPN}のうは かんがえごとが できないほど ちいさいけど\n"
            "{JPN}ねむらなくても へいき なので 24じかん あたりを\n"
            "{JPN}みはりつづけて いるぞ。"),
        .pokemonScale = 281,
        .pokemonOffset = 1,
        .trainerScale = 256,
    ...
    [SPECIES_FARIGIRAF] =
    {
        ...
        .weight = 1600,
        .description = COMPOUND_STRING(
            "{JPN}あたまと しっぽの 2つの のうはが どうきしたことで\n"
            "{JPN}エスパーパワーが キリンリキの 10ばい アップした。\n"
            "{JPN}かたい テールヘッドで ほんたいの あたまを まもりつつ\n"
            "{JPN}ながい くびを ふりまわして ずつきを くらわせる。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PINECO] =
    {
        ...
        .weight = 72,
        .description = COMPOUND_STRING(
            "{JPN}きの えだに ぶらさがり えものを まっている。 きを\n"
            "{JPN}ゆらされて しょくじの じゃまを されると じめんに\n"
            "{JPN}おちてから いきなり ばくはつするぞ。 きのかわを\n"
            "{JPN}だえきで はりあわせ あつく おおきくしていく。"),
        .pokemonScale = 445,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .weight = 1258,
        .description = COMPOUND_STRING(
            "{JPN}こうてつの カラの なかに ほんたいが いる。 えものを\n"
            "{JPN}つかまえる ときに カラが ひらくが あまりの はやさに\n"
            "{JPN}なかみは みえないのだ。 すきまから めだまが\n"
            "{JPN}のぞいているが なかみの しょうたいは なぞのまま。"),
        .pokemonScale = 293,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .weight = 140,
        .description = COMPOUND_STRING(
            "{JPN}ドリルの シッポを つかって うしろむきに じめんを\n"
            "{JPN}ほりすすみ ふくざつな かたちの すあなを ちちゅう\n"
            "{JPN}ふかくに つくる ポケモン。 ディグダと トンネルを\n"
            "{JPN}なかよく きょうよう している。"),
        .pokemonScale = 316,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_DUDUNSPARCE_TWO_SEGMENT] =
    {
        ...
        .weight = 392,
        .description = COMPOUND_STRING(
            "{JPN}かたい しっぽで ちちゅう ふかくの がんばんを くりぬき\n"
            "{JPN}すを つくる。 すあなは ながさ10キロに およぶ。 ほそ\n"
            "{JPN}ながい はいいっぱいに くうきを すいこみ きょうれつな\n"
            "{JPN}ばくふうを おこして てきを すから おいだす。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] =
    {
        ...
        .weight = 474,
        .description = COMPOUND_STRING(
            "{JPN}すあなに まよいこんだ ポケモンを せなかに のせて\n"
            "{JPN}いりぐちまで はこんであげる おんこうな きしつ。\n"
            "{JPN}からだの ふしの かずは いでんしで きまる ということが\n"
            "{JPN}さいきんの けんきゅうによって はんめいした。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .categoryName = _("とびさそり"),
        .height = 11,
        .weight = 648,
        .description = COMPOUND_STRING(
            "{JPN}おとを たてず すべる ように かっくうする。\n"
            "{JPN}てあしの まくで かぜに のって そらから おそいかかる\n"
            "{JPN}せんぽう。 りょううでの おおきな ツメと あしの ツメで\n"
            "{JPN}えもののかおに しがみつき どくばりを さす。"),
        .pokemonScale = 350,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .categoryName = _("キバさそり"),
        .height = 20,
        .weight = 425,
        .description = COMPOUND_STRING(
            "{JPN}しっぽで きのえだに ぶらさがり えものを かんさつする。\n"
            "{JPN}はおとを たてずに そらを とぶ。 ながい しっぽで\n"
            "{JPN}えものを つかまえ キバで きゅうしょを ひとつき。\n"
            "{JPN}すきを みて じょうくうから おそいかかる。"),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .weight = 78,
        .description = COMPOUND_STRING(
            "{JPN}キバを むきだして こわい かおを すれば ちいさな\n"
            "{JPN}ポケモンなら おびえて にげだす。 にげられた ブルーは\n"
            "{JPN}ちょっと さみしそう。 ひっしに いかくする\n"
            "{JPN}ひょうじょうが じょせいに にんき。"),
        .pokemonScale = 465,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .weight = 487,
        .description = COMPOUND_STRING(
            "{JPN}したアゴが とても はったつした ポケモン。 キバが\n"
            "{JPN}おもたいので くびを かしげている。 おどろかさなければ\n"
            "{JPN}むやみに かみつかない。 かおに にあわず おくびょう。\n"
            "{JPN}わかい じょせいに だいにんき。"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .weight = 39,
        .description = COMPOUND_STRING(
            "{JPN}のみこんだ みずの ちからを りようして ぜんしんの\n"
            "{JPN}どくばりを いっせいに うちだす。 およぐのは ちょっと\n"
            "{JPN}にがてな ポケモンだ。 あいてが おおきいほど からだが\n"
            "{JPN}はれつする げんかいまで みずを のみこむ。"),
        .pokemonScale = 430,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .weight = 39,
        .description = COMPOUND_STRING(
            "{JPN}エサから どくそを せっしゅする。 さむい とちの みずべに\n"
            "{JPN}せいそくする。 どくばりは ふとく みじかい。\n"
            "{JPN}むらさきいろが きわだつ はりは もうどくを たたえた\n"
            "{JPN}しょうこ。"),
        .pokemonScale = 430,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_OVERQWIL] =
    {
        ...
        .weight = 605,
        .description = COMPOUND_STRING(
            "{JPN}きょうぼうで きしょうが あらい。 ねむっているときでも\n"
            "{JPN}うごくものが ちかづくと どくばりが むいしきに\n"
            "{JPN}はんのうし つきさしてくる。 どくばりの せんたんは\n"
            "{JPN}ギザギザで ささると かんたんには ぬけない。"),
        .pokemonScale = 257,
        .pokemonOffset = 10,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .weight = 205,
        .description = COMPOUND_STRING(
            "{JPN}いわの したで こうらの なかに たくわえた きのみを\n"
            "{JPN}たべながら みを ひそめている。 のうち きのみは\n"
            "{JPN}はっこうして たいえきと まざり きのみは おいしい\n"
            "{JPN}ジュースに なるのだ。"),
        .pokemonScale = 485,
        .pokemonOffset = 18,
        .trainerScale = 256,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .weight = 540,
        .description = COMPOUND_STRING(
            "{JPN}あまい じゅえきを もとめて もりに あつまる。 てあしの\n"
            "{JPN}するどい ツメが じめんや じゅもくに ふかく\n"
            "{JPN}くいこむので じまんの ツノで あいてを なげとばす とき\n"
            "{JPN}おもいっきり ふんばれるのだ。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_HERACROSS_MEGA] =
    {
        ...
        .weight = 625,
        .description = COMPOUND_STRING(
            "{JPN}すさまじい エネルギーを あびて ビルドアップ。 2ほんの\n"
            "{JPN}ツノで はさみこみ じぶんの たいじゅうの 500ばいの\n"
            "{JPN}おもさの ものも もちあげることが できるのだ。 メガ\n"
            "{JPN}シンカが おわると ひどい きんにくつうに なる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "{JPN}てあしの カギヅメを つきたてて きを のぼる。 おやの\n"
            "{JPN}いない すきを ねらって きの うえに ある す から\n"
            "{JPN}タマゴを ぬすんで たべる。 じぶんが めだたないよう\n"
            "{JPN}くらやみに まぎれて えものに おそいかかる。"),
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .weight = 340,
        .description = COMPOUND_STRING(
            "{JPN}ゆきの おおい ちほうに せいそく。 じゅもくに ツメで\n"
            "{JPN}サインを えがき なかまに あいずを おくる。 すうひきの\n"
            "{JPN}グループは みごとな れんけいで えものを おいつめる。\n"
            "{JPN}しんかして さらに ずるがしこくなった。"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .weight = 270,
        .description = COMPOUND_STRING(
            "{JPN}カギヅメは たくましく するどい。 いわばを いどうする\n"
            "{JPN}のに てきした かたち。 カギヅメの せんたんから\n"
            "{JPN}どくえきを だして えものを うごけなくして とらえる。\n"
            "{JPN}ずるがしこい せいかく。"),
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .weight = 430,
        .description = COMPOUND_STRING(
            "{JPN}しんかして からだは おおきく てあしも ながくなった。\n"
            "{JPN}たかい しんたいのうりょくで りょうてあしの するどい\n"
            "{JPN}ツメを ひっかけて がけを のぼる。 こうちを なわばり\n"
            "{JPN}として たんどくで くらす。"),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}ヒメグマの ハチミツは くだものと スピアーの あつめた\n"
            "{JPN}かふんが ブレンドされて つくられる。\n"
            "{JPN}ヒメグマによって あじが ちがう。"),
        .pokemonScale = 455,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}たいぼくや おがわが あちこちに あると いう。 まいにち\n"
            "{JPN}エサを あつめて もりを あるく。 きに おおきな\n"
            "{JPN}ツメあとが あったら そこは リングマの ナワバリ。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .weight = 2900,
        .description = COMPOUND_STRING(
            "{JPN}でいたんが ほうふな かんきょうの えいきょうを うけて\n"
            "{JPN}しんかした。 ひたいには くもが かかった まんげつの\n"
            "{JPN}ような もようがある。 せなかと てあしには はいいろの\n"
            "{JPN}どろが かたまったまま ついている。"),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [SPECIES_URSALUNA_BLOODMOON] =
    {
        ...
        .weight = 3330,
        .description = COMPOUND_STRING(
            "{JPN}うみを わたり ながれついた とちで いきぬいた\n"
            "{JPN}とくべつな すがたと のうりょくの ガチグマ。\n"
            "{JPN}てつのように かたい どろで みを まもり やみを\n"
            "{JPN}みとおす ひだりめを もっている。"),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .weight = 350,
        .description = COMPOUND_STRING(
            "{JPN}かざんちたいで くらす ポケモンの いっしゅ。 からだが\n"
            "{JPN}ひえると ひふが かたまってしまい うごけなくなるため\n"
            "{JPN}マグマの そばで ねむる。 あたたかい ところを さがして\n"
            "{JPN}のろのろ はいずりまわっている。"),
        .pokemonScale = 329,
        .pokemonOffset = 15,
        .trainerScale = 256,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}なんまんねんもの あいだ かざんの かこうで くらす\n"
            "{JPN}うちに からだが マグマに なった。 カラの\n"
            "{JPN}すきまから ほのおを ふきだす。"),
        .pokemonScale = 332,
        .pokemonOffset = 15,
        .trainerScale = 256,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}かれくさの したに はえた キノコが こうぶつ。\n"
            "{JPN}こおった じめんも へっちゃらだ。 たまに\n"
            "{JPN}おんせんを ほりあてる ことが あるよ。"),
        .pokemonScale = 324,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .weight = 558,
        .description = COMPOUND_STRING(
            "{JPN}こごえる さむさにも たえられる ように あつくて ながい\n"
            "{JPN}けがわに おおわれている。 こおりに うまった エサを\n"
            "{JPN}キバで ほりだす。 4ほんの あしは みじかいが ヒヅメは\n"
            "{JPN}ひろく ギザギザ なので ゆきのうえでも すべらない。"),
        .pokemonScale = 306,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .weight = 2910,
        .description = COMPOUND_STRING(
            "{JPN}1まんねんまえの こおりの したから はっけんされた\n"
            "{JPN}ことも あるほど おおむかしから いた ポケモン。\n"
            "{JPN}こおりで できた りっぱな キバ。 ひょうがきが おわり\n"
            "{JPN}あたたかく なったため かずが へってしまった。"),
        .pokemonScale = 257,
        .pokemonOffset = 6,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .weight = 50,
        .description = COMPOUND_STRING(
            "{JPN}あたたかい みなみの うみに せいそくする。 うみが\n"
            "{JPN}よごれると うつくしい サンゴのえだは いろが くすみ\n"
            "{JPN}ボロボロに なってしまう。 サンゴの えだは たいようの\n"
            "{JPN}ひかりを あびると なないろに キラキラ かがやく。"),
        .pokemonScale = 410,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CORSOLA_GALAR] =
    {
        ...
        .weight = 5,
        .description = COMPOUND_STRING(
            "{JPN}おおむかし うみだった ばしょに よく ころがっている。\n"
            "{JPN}いしころと まちがえて けると たたられる。\n"
            "{JPN}きゅうな かんきょうの へんかで しんだ たいこの\n"
            "{JPN}サニーゴ。 えだで ひとの せいきを すう。"),
        .pokemonScale = 410,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .weight = 4,
        .description = COMPOUND_STRING(
            "{JPN}れいりょくが たかまり カラから ときはなたれた。\n"
            "{JPN}れいたいで かくの たましいを まもっている。\n"
            "{JPN}たましいを おおう れいたいの からだには ちゅうい。\n"
            "{JPN}ふれると いしのように うごけなく なるぞ。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .weight = 120,
        .description = COMPOUND_STRING(
            "{JPN}のんだ みずを ふっきんを つかい いきおいよく ふきだして\n"
            "{JPN}そらを とぶ えものを しとめる。しんかが ちかづくと\n"
            "{JPN}かわを くだっていく。 マンタインの からだに くっついて\n"
            "{JPN}たべのこしを わけてもらっている。"),
        .pokemonScale = 316,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
            "{JPN}きゅうばんの うでで あいてに からみつく。 うごけなく\n"
            "{JPN}なった ところを しとめるのだ。 かなわない ときは\n"
            "{JPN}スミを はいて にげる。 かいていの いわかげや あなを\n"
            "{JPN}すみかにして くらす。"),
        .pokemonScale = 296,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}デリバードに エサを わけてもらった おかげで\n"
            "{JPN}エベレストを のぼりきれた ぼうけんかが いた。\n"
            "{JPN}1にち ずっと えさをはこんでる。"),
        .pokemonScale = 293,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .weight = 650,
        .description = COMPOUND_STRING(
            "{JPN}かいめんの ちかくを およぐため ふねの うえから せなかの\n"
            "{JPN}もようを かんさつする ことが できる。 せなかの もようは\n"
            "{JPN}ちいきによって ことなっている。テッポウオの むれに\n"
            "{JPN}まざって およぐことが おおい。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}マンタインの むれを みることが できるよ。 テッポウオが\n"
            "{JPN}くっついていても きにしない。 じゆうきままに\n"
            "{JPN}およぎながら くちに はいってきた モノをたべる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .weight = 505,
        .description = COMPOUND_STRING(
            "{JPN}はがねの からだと ハネを もつ ポケモン。 むかしの\n"
            "{JPN}ひとは ぬけおちた ハネを つかって かたなや\n"
            "{JPN}ほうちょうを つくっていた。 じそく 300キロの スピードで\n"
            "{JPN}そらを とび かたなの きれあじを もつ ハネで きりさく。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 271,
        .trainerOffset = 1,
    ...
    [SPECIES_SKARMORY_MEGA] =
    {
        ...
        .weight = 404,
        .description = COMPOUND_STRING(
            "{JPN}メガシンカの えいきょうで からだは きんいろに なり\n"
            "{JPN}きょだいな あしの ツメが とくちょう。 ひこうそくどは\n"
            "{JPN}おんそくを こえる。 しょうげきはで てきを ふきとばし\n"
            "{JPN}ツメで とどめを さす。"),
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .weight = 108,
        .description = COMPOUND_STRING(
            "{JPN}さまざまな なきごえを つかいわけ なかまと れんらくを\n"
            "{JPN}とりあい えものを おいこんでいく。 チームワークの\n"
            "{JPN}みごとさは ポケモンずいいち。 パートナーに なると\n"
            "{JPN}トレーナーの めいれいに とっても ちゅうじつだ。"),
        .pokemonScale = 393,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .weight = 350,
        .description = COMPOUND_STRING(
            "{JPN}あたまの ツノが おおきく そりかえって いる ヘルガーが\n"
            "{JPN}グループの リーダーてき そんざい。 なかま どうしで\n"
            "{JPN}あらそい リーダーが きまる。 くちから ふきだす\n"
            "{JPN}ほのおは たいないの どくそを もやしたもの。"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .weight = 495,
        .description = COMPOUND_STRING(
            "{JPN}メガシンカで ぜんしんが はつねつ。 はげしい ほのおの\n"
            "{JPN}いぶきを ふきだし あいてを すみに かえる。\n"
            "{JPN}あかいツメや シッポの せんたんは ヘルガー じしんが\n"
            "{JPN}くるしむほどの こうおんで すでに とけかけている。"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .categoryName = _("{JPN}ながはな"),
        .height = 5,
        .weight = 335,
        .description = COMPOUND_STRING(
            "{JPN}ゴマゾウの おおきな みみは うちわの かわり。\n"
            "{JPN}あつくなると ぱたぱた あおいで すずむ。 こどもでも\n"
            "{JPN}ちからは とても つよい。 ながい はなを つかって\n"
            "{JPN}みずあびを する。"),
        .pokemonScale = 465,
        .pokemonOffset = 21,
        .trainerScale = 256,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "{JPN}ダンプカーを らくらく ひっぱる ちからもち。 いわの\n"
            "{JPN}ように かたくなった ひふは すこしの こうげきでは\n"
            "{JPN}キズも つかない。 ころがり はじめると なかなか\n"
            "{JPN}とまれなくなる。"),
        .pokemonScale = 313,
        .pokemonOffset = 9,
        .trainerScale = 256,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .weight = 712,
        .description = COMPOUND_STRING(
            "{JPN}みごとな かたちの ツノは びじゅつひん として たかく\n"
            "{JPN}うれた ために ぜつめつ すんぜんまで らんかくされた\n"
            "{JPN}ことのある ポケモン。 ぬけおちた ツノの ねもとの まるい\n"
            "{JPN}たまを こなにして のむと ぐっすり ねむれる といわれる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .weight = 951,
        .description = COMPOUND_STRING(
            "{JPN}ぬけげは ぼうかんぎの ざいりょうにも なる。 ツノの\n"
            "{JPN}たまからは きょうりょくな サイコエネルギーを だす。\n"
            "{JPN}ツノを アンテナとして つかい あんぜんな みちを さがし\n"
            "{JPN}オドシシの むれを ひきいている。"),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .weight = 580,
        .description = COMPOUND_STRING(
            "{JPN}しっぽの さきから にじみでる たいえきで なわばりの\n"
            "{JPN}まわりに じぶんの マークを かく。 5000 しゅるいの\n"
            "{JPN}マークが みつかっている。 ドーブルの おおい まちの\n"
            "{JPN}かべは らくがき だらけ。"),
        .pokemonScale = 287,
        .pokemonOffset = 5,
        .trainerScale = 256,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .weight = 755,
        .description = COMPOUND_STRING(
            "{JPN}まいにち 20リットルの ミルクを だす。 あまい ミルクは\n"
            "{JPN}おとなも こどもも だいすき。 にがてな ひとは\n"
            "{JPN}ヨーグルトにして たべている。 そのミルクは えいよう\n"
            "{JPN}まんてんで こうカロリー。"),
        .pokemonScale = 280,
        .pokemonOffset = 5,
        .trainerScale = 256,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .weight = 1780,
        .description = COMPOUND_STRING(
            "{JPN}かみなりの スピードを やどした ポケモン。 その\n"
            "{JPN}とおぼえは かみなりが おちた ときの ように くうきを\n"
            "{JPN}ふるわせ だいちを ゆるがす。 せなかの あまぐもから\n"
            "{JPN}カミナリを うちだすことが できる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .weight = 1980,
        .description = COMPOUND_STRING(
            "{JPN}マグマの じょうねつを やどした ポケモン。 かざんの\n"
            "{JPN}ふんかから うまれたと かんがえられ すべてを やきつくす\n"
            "{JPN}ほのおを ふきあげる。 エンテイが ほえると せかいの\n"
            "{JPN}どこかの かざんが ふんかすると いわれている。"),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .weight = 1870,
        .description = COMPOUND_STRING(
            "{JPN}わきみずの やさしさを やどした ポケモン。 すべる\n"
            "{JPN}ような みのこなしで だいちを はしり にごった みずを\n"
            "{JPN}きよめる ちからを もつ。 せかいじゅうを かけめぐり\n"
            "{JPN}きたかぜと ともに はしりさる。"),
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 345,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .weight = 720,
        .description = COMPOUND_STRING(
            "{JPN}ちちゅう ふかくで うまれる ヨーギラスは つちを\n"
            "{JPN}たべつくして ちじょうへ でないと おやの かおを みる\n"
            "{JPN}ことが できないのだ。 おおきな やまを たいらげると\n"
            "{JPN}せいちょうのため ねむりはじめる。"),
        .pokemonScale = 472,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}いきおいよく ふんしゃする ことで とんでいく。\n"
            "{JPN}こうてつに ぶつかっても へいきな ボディだ。\n"
            "{JPN}さなぎだが じっと していない。"),
        .pokemonScale = 292,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "{JPN}くずしてしまう ほどの つよい パワーを もつ。 たたかう\n"
            "{JPN}あいてを もとめて やまを さまよう。 であっても\n"
            "{JPN}かくしたが あいてだと むしして さっていく。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_TYRANITAR_MEGA] =
    {
        ...
        .weight = 2550,
        .description = COMPOUND_STRING(
            "{JPN}メガシンカの えいきょうで さらに きょうぼうに なった。\n"
            "{JPN}すさまじいパワーを ちゅうにゅうされ せなかが さけて\n"
            "{JPN}しまった。 ただただ はかいする ほんのうのみで うごく。\n"
            "{JPN}トレーナーの めいれいも きこえているか ふめい。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .weight = 2160,
        .description = COMPOUND_STRING(
            "{JPN}つばさを かるく はばたかせた だけで みんかを ふきとばす\n"
            "{JPN}はかいりょくを もっている ために かいていで ひとしれず\n"
            "{JPN}くらす ように なった。 ふかい かいこうの そこで ねむる\n"
            "{JPN}うみのかみさま と つたえられる ポケモン。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .weight = 1990,
        .description = COMPOUND_STRING(
            "{JPN}ひかりの あたる かくどに よって なないろに かがやく\n"
            "{JPN}ハネは しあわせを もたらすと いう。  にじの ふもとに\n"
            "{JPN}すむと いわれている。 こころただしき トレーナーの\n"
            "{JPN}まえに すがたをあらわすと つたえられる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 610,
        .trainerOffset = 17,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .weight = 50,
        .description = COMPOUND_STRING(
            "{JPN}ときを こえ みらいから やってきた ポケモン。 セレビィが\n"
            "{JPN}すがたを あらわす かぎり あかるい みらいが まっていると\n"
            "{JPN}かんがえられている。 もりの かみさまとして さまざまな\n"
            "{JPN}じだいに きろくが のこされている。"),
        .pokemonScale = 393,
        .pokemonOffset = -10,
        .trainerScale = 256,
        .trainerOffset = 0,
